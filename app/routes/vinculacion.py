...
def Home():
    ...
    if 'correo' in session:
        ...
        if administrador:
            ...
            return render_template("Vinculacion/alumnos.html", alumnos=alumnos_con_progreso, periodos=periodos, administrador=admin,mostrar_modal=not acepto_terminos)
        else:
...
def aceptar_documento_nuevo_uta():
    ...
    if Tipo_estadía == 'documentos_Especiales':
        documentos_Especiales_data = {
            ...
            "carnet_del_seguro_social": {"estado": "activo", "archivo": None, "comentario": None},
            "vigencia_del_seguro_social": {"estado": "activo", "archivo": None, "comentario": None},
            "carta_compromiso_para_realizar_estadías": {"estado": "desactivado", "archivo": None, "comentario": None},
            "formato_autorizacion_estadías": {"estado": "desactivado", "archivo": None, "comentario": None},
            "kardex": {"estado": "desactivado", "archivo": None, "comentario": None, "descripcion":"Debe estar firmado y sellado por servicios escolares"},
            ...
            "carta_aceptación_por_parte_de_la_empresa": {"estado": "desactivado", "archivo": None, "comentario": None},
            "registro_estadía": {"estado": "desactivado", "archivo": None, "comentario": None},
            "cronograma_de_actividades": {"estado": "desactivado", "archivo": None, "comentario": None, "descripcion":"Debe contener minimo 16 actividades."},
            "1er_informe": {"estado": "desactivado", "archivo": None, "comentario": None, "descripcion":"Debe estar sellado por la empresa, firmado por el asesor empresarial y el asesor academico."},
            "2do_informe": {"estado": "desactivado", "archivo": None, "comentario": None, "descripcion":"Debe estar sellado por la empresa, firmado por el asesor empresarial y el asesor academico."},
            "3er_informe": {"estado": "desactivado", "archivo": None, "comentario": None, "descripcion":"Debe estar sellado por la empresa, firmado por el asesor empresarial y el asesor academico."},
            "evaluación_de_estadía_por_parte_de_la_empresa": {"estado": "desactivado", "archivo": None, "comentario": None, "descripcion":"Debe estar sellado por la empresa y sellado."},
            "carta_de_liberación_de_estadía_por_parte_de_la_empresa": {"estado": "desactivado", "archivo": None, "comentario": None, "descripcion":"Debe ser en hoja membretada y con sello de la empresa."},
            "cuestionario_para_empleado": {"estado": "desactivado", "archivo": None, "comentario": None, "descripcion":"Documento de seguimiento de egreso"},
            "ficha_de_registro": {"estado": "desactivado", "archivo": None, "comentario": None,"descripcion":"Documento de seguimiento de egreso"},
            "evaluación_a_las_empresas": {"estado": "desactivado", "archivo": None, "comentario": None,"descripcion":"Documento de seguimiento de egreso"},
            "cuestionario_satisfacción_del_cliente": {"estado": "desactivado", "archivo": None, "comentario": None,"descripcion":"Documento de seguimiento de egreso"},
            "cuestionario_final_laboral": {"estado": "desactivado", "archivo": None, "comentario": None,"descripcion":"Documento de seguimiento de egreso"},
        ...
        documentos_Foraneas_data = {
            ...
            "formato_autorizacion_estadías": {"estado": "desactivado", "archivo": None, "comentario": None},
           "kardex": {"estado": "desactivado", "archivo": None, "comentario": None, "descripcion":"Debe estar firmado y sellado por servicios escolares"},
            "carta_compromiso_para_estadía_foránea": {"estado": "desactivado", "archivo": None, "comentario": None},
            "acuse_solicitud_de_espacio": {"estado": "desactivado", "archivo": None, "comentario": None},
            "acuse_carta_presentación": {"estado": "desactivado", "archivo": None, "comentario": None},
            "carta_aceptación_por_parte_de_la_empresa": {"estado": "desactivado", "archivo": None, "comentario": None},
            "registro_estadía": {"estado": "desactivado", "archivo": None, "comentario": None},
        ...
        documentosTSU_data = {
            ...
            "vigencia_del_seguro_social": {"estado": "activo", "archivo": None, "comentario": None},
            "carta_compromiso_para_realizar_estadías": {"estado": "desactivado", "archivo": None, "comentario": None},
            "formato_de_autorización_estadías": {"estado": "desactivado", "archivo": None, "comentario": None},
            "kardex": {"estado": "desactivado", "archivo": None, "comentario": None, "descripcion":"Debe estar firmado y sellado por servicios escolares"},
            "acuse_solicitud_de_espacio": {"estado": "desactivado", "archivo": None, "comentario": None},
            "acuse_carta_presentación": {"estado": "desactivado", "archivo": None, "comentario": None},
            "carta_aceptación_por_parte_de_la_empresa": {"estado": "desactivado", "archivo": None, "comentario": None},
        ...
        documentosLIC_ING_data = {
            ...
            "cuestionario_final_laboral": {"estado": "desactivado", "archivo": None, "comentario": None,"descripcion":"Documento de seguimiento de egreso"},
            "carta_liberación_de_memoria": {"estado": "desactivado", "archivo": None, "comentario": None},
            "memoria_digital": {"estado": "desactivado", "archivo": None, "comentario": None}
        }
