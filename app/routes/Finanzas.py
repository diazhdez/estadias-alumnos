...
import pandas as pd
Finanzas_routes = Blueprint('Finanzas', __name__)


@Finanzas_routes.route("/EduLink/Finanzas/administrar_Alumnos/")
@nocache
@requiere_permisos(permisos_requeridos=["update", "view"], departamento_requerido="finanzas")
def Finanzas():
